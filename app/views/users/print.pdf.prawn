...
pdf.text "Svojím podpisom zároveň potvrdzujem, že som bol/a poučený/a o existencii  práv dotknutej osoby.", :leading => 4

pdf.text "\n\n\n\n\n\n\n"

pdf.text "V ________________________, dňa _____________________", :align => :right
pdf.text "\n\n\n\n\n"

pdf.text "__________________________", :align => :right
pdf.text "podpis", :align => :right

pdf.move_cursor_to 20
pdf.font_size 7
pdf.text "#{current_user.id}"