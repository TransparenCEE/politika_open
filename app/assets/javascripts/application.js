...
$(document).ready(function () {
    ...
    $("select.bound").each(function () {
        ...
        bound.change(function () {
            var parent = $(this).find('option:selected').parent();
            if (parent.is("optgroup")) {
                var label = parent.attr('label');
                bound_to.find("option[value='" + label + "']").attr('selected','selected');
            }
        });

        //hotfix - select selected value when selected value who have multiple currencies
